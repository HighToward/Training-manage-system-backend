...
INSERT INTO `chapter` VALUES (9013, 7005, 1, '认识Spring框架', '/uploads/video/2a5aadca-3886-4610-b479-eaae975ae8ad.mp4', '2025-06-10 16:24:24', 0, '2025-06-12 14:06:14');
...
INSERT INTO `course` VALUES (7005, 2001, 'SpringBoot实战项目开发', 'SpringBoot是一门非常前沿且流行的后端框架，可以与Mybatis、JPA等主流ORM搭配使用', '/uploads/img/f8bab475-25d8-44f8-9905-8a49616f636d.png', 6003, 6001, 1, 1, 0, 0, 0, 0, 1, 0, '2025-06-05 23:01:29', '2025-06-12 14:09:38');
...
) ENGINE = InnoDB AUTO_INCREMENT = 27003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资讯收藏记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `information_comments`  (
  ...
  `deleted` int NOT NULL DEFAULT 0 COMMENT '删除标记(0:未删除,1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28028 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资讯评论表' ROW_FORMAT = Dynamic;
...
INSERT INTO `information_comments` VALUES (28027, 26008, 2002, '123213', 0, 2002, 28026, '2025-06-14 13:23:08', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资讯点赞记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `practice`  (
  ...
  `deleted` int NOT NULL DEFAULT 0 COMMENT '删除标记(0:未删除,1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '课程实践活动表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `topic_question` VALUES (1, 1001, NULL, 0, 'Python中的装饰器如何使用？', 5, '技术问题', 3, '2023-03-07 09:00:00', 0, '2025-06-13 15:50:48', 3001);
INSERT INTO `topic_question` VALUES (2, 1002, 2002, 1, '机器学习中如何选择正确的算法？', 8, '技术问题', 5, '2023-03-08 10:00:00', 0, '2025-06-13 15:50:50', 3002);
...
) ENGINE = InnoDB AUTO_INCREMENT = 33035 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '问题评论表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of topic_question_comment
-- ----------------------------
INSERT INTO `topic_question_comment` VALUES (33034, 2, NULL, 2002, '213123', 0, 0, 2002, 33033, '2025-06-14 14:44:03', '2025-06-14 14:44:03', 0);
INSERT INTO `topic_question_comment` VALUES (33033, 2, NULL, 2002, '213123', 0, 0, 2002, 33032, '2025-06-14 14:27:57', '2025-06-14 14:27:57', 0);
INSERT INTO `topic_question_comment` VALUES (33032, 2, NULL, 2002, '21321', 0, 0, 2002, 33031, '2025-06-14 14:20:42', '2025-06-14 14:20:42', 0);
...
INSERT INTO `topic_question_comment` VALUES (33029, 2, NULL, 2002, '213213', 0, 0, 0, 0, '2025-06-14 14:10:45', '2025-06-14 14:10:45', 0);
INSERT INTO `topic_question_comment` VALUES (33027, 2, NULL, 2002, '123213123', 0, 0, 0, 33026, '2025-06-14 13:59:19', '2025-06-14 13:59:19', 0);
INSERT INTO `topic_question_comment` VALUES (33026, 2, NULL, 2002, '213123', 0, 0, 0, 0, '2025-06-14 13:59:16', '2025-06-14 13:59:16', 0);
INSERT INTO `topic_question_comment` VALUES (33025, 2, NULL, 2002, '是的', 0, 0, 0, 0, '2025-06-14 13:52:55', '2025-06-14 13:52:55', 0);
INSERT INTO `topic_question_comment` VALUES (33024, 2, NULL, 2002, '是的', 0, 0, 0, 0, '2025-06-14 13:49:58', '2025-06-14 13:49:58', 0);
...
INSERT INTO `user` VALUES (1002, 1, 'student2', '$2a$10$hJhlg9uddcZjVQSPMC2KMO4y1vaqQxE8W3lOv1x4mm1l0J4TdQqBK', 'https://example.com/avatars/student2.jpg', '2023-01-02 11:00:00', 0, '2025-06-13 17:04:51');
...
INSERT INTO `user` VALUES (2002, 0, 'teacher2', '$2a$05$EDmIfTlEbJJd6YGTFGGn.eFazMB89bZJynTXTxKOiIdhg/IwBrpxa', '/uploads/avatar/avatar_7da0c8cd-a0b0-4704-911a-71b649e0da8f.png', '2023-01-04 14:00:00', 0, '2025-06-14 22:43:55');
