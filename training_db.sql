...
) ENGINE = InnoDB AUTO_INCREMENT = 9017 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `chapter` VALUES (9013, 7005, 1, '认识Spring框架', '/uploads/video/2a5aadca-3886-4610-b479-eaae975ae8ad.mp4', '2025-06-10 16:24:24', 0, '2025-06-16 14:12:45');
INSERT INTO `chapter` VALUES (9014, 7005, 2, 'mybatis的用法', '', '2025-06-15 20:29:14', 0, '2025-06-16 14:12:45');
INSERT INTO `chapter` VALUES (9015, 7005, 2, 'mybatis的用法', '', '2025-06-15 20:29:15', 1, '2025-06-15 20:29:18');
INSERT INTO `chapter` VALUES (9016, 7005, 3, '测试', '', '2025-06-15 20:29:27', 0, '2025-06-16 14:12:45');
...
INSERT INTO `class` VALUES (3003, '软件232班', 2, '2025-05-10 18:48:32', 0, '2025-06-13 15:25:38');
...
INSERT INTO `class` VALUES (3008, '软件231', 2, '2025-05-26 17:06:16', 0, '2025-06-12 14:46:00');
...
CREATE TABLE `context_subtype`  (
  ...
  `deleted` int NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `context_violations`  (
  ...
  `deleted` int NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '内容违规记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `course`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7008 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '课程信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `course` VALUES (7005, 2001, 'SpringBoot实战项目开发', 'SpringBoot是一门非常前沿且流行的后端框架，可以与Mybatis、JPA等主流ORM搭配使用', '/uploads/img/f8bab475-25d8-44f8-9905-8a49616f636d.png', 6003, 6001, 1, 3, 0, 0, 0, 0, 1, 0, '2025-06-05 23:01:29', '2025-06-16 15:50:39');
INSERT INTO `course` VALUES (7006, 2001, '1213123', '123213123123213123', '', 6002, 6001, 0, 0, 0, 0, 0, 0, 0, 1, '2025-06-12 16:04:51', '2025-06-12 16:04:54');
INSERT INTO `course` VALUES (7007, 2001, '123213123', '213213213213213', '', 6002, 6001, 0, 0, 0, 0, 0, 0, 0, 1, '2025-06-13 15:01:16', '2025-06-13 15:01:33');
...
CREATE TABLE `course_appraise`  (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '课程评价表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `course_class`  (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8030 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '课程-班级关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of course_class
-- ----------------------------
INSERT INTO `course_class` VALUES (8026, 7001, 3002, '2025-05-26 17:06:54', '2025-05-26 17:06:54');
INSERT INTO `course_class` VALUES (8028, 7005, 3008, '2025-06-13 15:23:45', '2025-06-13 15:23:45');
INSERT INTO `course_class` VALUES (8029, 7005, 3003, '2025-06-13 15:25:43', '2025-06-13 15:25:43');
...
CREATE TABLE `course_interaction`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '互动记录ID',
  `cou_id` bigint NOT NULL COMMENT '课程ID',
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '课程互动记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `course_type`  (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6006 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '课程类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `image_subtype`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '图片子类型ID',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '子类型名称',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted` int NOT NULL DEFAULT 0 COMMENT '删除标记(0:未删除,1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '图片子类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `image_violations`  (
  ...
  `deleted` int NOT NULL DEFAULT 0 COMMENT '删除标记(0:未删除,1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 43003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '图片违规记录表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `information` VALUES (26001, 2001, 'Python 3.11新特性', '<p>Python 3.11带来了多项性能改进和新特性...</p>', 1, 0, 2, '/uploads/img/5e440074-8b2e-4aab-ba76-1251a98667b4.png', '2023-02-24 09:00:00', 0, '2025-06-16 17:12:42');
...
) ENGINE = InnoDB AUTO_INCREMENT = 27008 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资讯收藏记录表' ROW_FORMAT = Dynamic;
...
INSERT INTO `information_collection` VALUES (27003, 2002, 26008, '2025-06-16 09:19:32', '2025-06-16 11:49:36', 1);
...
CREATE TABLE `information_comments`  (
  ...
  `deleted` int NOT NULL DEFAULT 0 COMMENT '删除标记(0:未删除,1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28029 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资讯评论表' ROW_FORMAT = Dynamic;
...
INSERT INTO `information_comments` VALUES (28014, 26007, 2001, '123123', 0, 0, 0, '2025-06-08 12:17:32', NULL, 1);
...
INSERT INTO `information_comments` VALUES (28018, 26007, 2002, '213213', 0, 0, 0, '2025-06-08 12:43:33', NULL, 1);
INSERT INTO `information_comments` VALUES (28019, 26008, 2002, '123123', 0, 0, 0, '2025-06-08 12:45:06', NULL, 1);
INSERT INTO `information_comments` VALUES (28020, 26007, 2001, 'DeepSeek：裂帛之声', 0, 0, 0, '2025-06-12 06:10:15', NULL, 0);
INSERT INTO `information_comments` VALUES (28021, 26007, 2001, '123213123', 0, 2001, 28020, '2025-06-12 08:07:39', NULL, 1);
INSERT INTO `information_comments` VALUES (28022, 26007, 2001, '你好李教授', 0, 2002, 28017, '2025-06-12 08:10:01', NULL, 1);
INSERT INTO `information_comments` VALUES (28023, 26007, 2001, '好的', 0, 2001, 28021, '2025-06-12 08:10:25', NULL, 1);
INSERT INTO `information_comments` VALUES (28024, 26007, 2001, '当你仰望星空时，你是否想过也有人在俯视看向你？', 0, 2002, 28017, '2025-06-12 12:42:02', NULL, 0);
INSERT INTO `information_comments` VALUES (28025, 26008, 2002, '人工智能太强大了', 0, 2002, 28015, '2025-06-13 08:52:05', NULL, 0);
INSERT INTO `information_comments` VALUES (28026, 26008, 2002, '是的', 0, 2002, 28025, '2025-06-14 13:22:00', NULL, 0);
INSERT INTO `information_comments` VALUES (28027, 26008, 2002, '123213', 0, 2002, 28026, '2025-06-14 13:23:08', NULL, 1);
INSERT INTO `information_comments` VALUES (28028, 26008, 2002, '213123', 0, 2002, 28027, '2025-06-14 15:26:21', NULL, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资讯评论点赞记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of information_comments_like
-- ----------------------------
INSERT INTO `information_comments_like` VALUES (1, 1001, 28001, '2023-03-03 09:00:00', '2025-06-13 17:01:03', 0);
INSERT INTO `information_comments_like` VALUES (2, 1002, 28001, '2023-03-04 10:00:00', '2025-06-13 17:01:04', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '资讯点赞记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of information_like
-- ----------------------------
INSERT INTO `information_like` VALUES (1, 1001, 26001, '2023-03-05 09:00:00', 0, '2025-06-13 17:01:10');
INSERT INTO `information_like` VALUES (2, 1002, 26002, '2023-03-06 10:00:00', 0, '2025-06-13 17:01:11');
...
) ENGINE = InnoDB AUTO_INCREMENT = 12002 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生学习进度记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `message_comments`  (
  ...
  `deleted` int NOT NULL DEFAULT 0 COMMENT '删除标记(0:未删除,1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 37003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消息评论表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 38003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '消息点赞记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `message_system`  (
  ...
  `deleted` int NOT NULL DEFAULT 0 COMMENT '删除标记(0:未删除,1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 39003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统消息通知表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `practice`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '实践活动ID',
  `tea_id` bigint NOT NULL COMMENT '教师ID',
  `cou_id` bigint NOT NULL COMMENT '关联课程ID',
  `pra_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '实践活动名称',
  ...
  `deleted` int NOT NULL DEFAULT 0 COMMENT '删除标记(0:未删除,1:已删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '课程实践活动表' ROW_FORMAT = Dynamic;
...
INSERT INTO `practice` VALUES (24003, 2001, 7005, 'Springboot实训项目-企业内部培训管理系统', '广东轻工职业技术大学实训楼C101', '', '2025-06-16 16:00:00', '2025-06-17 16:00:00', 1, '2025-06-16 22:03:22', '2025-06-16 22:03:22', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (1001, 1001, '张三', 3600, 400, '1010101', '2023-01-01 10:05:00', 0, '2025-06-11 11:27:38');
INSERT INTO `student` VALUES (1002, 1002, '李四', 1800, 280, '0101010', '2023-01-02 11:05:00', 0, '2025-06-13 14:47:38');
...
) ENGINE = InnoDB AUTO_INCREMENT = 4069 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生班级关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student_class
-- ----------------------------
INSERT INTO `student_class` VALUES (4065, 1001, 3008, '2025-06-12 14:45:59', '2025-06-12 14:45:59');
INSERT INTO `student_class` VALUES (4066, 1002, 3008, '2025-06-12 14:46:00', '2025-06-12 14:46:00');
INSERT INTO `student_class` VALUES (4067, 1001, 3003, '2025-06-13 15:25:38', '2025-06-13 15:25:38');
INSERT INTO `student_class` VALUES (4068, 1002, 3003, '2025-06-13 15:25:38', '2025-06-13 15:25:38');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生打卡记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 10004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生课程关联表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 15002 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生课程购物车表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 16003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生课程收藏关联表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 17003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生课程点赞表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生课程学习进度表(自选课程)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `student_order`  (
  ...
  INDEX `idx_stu_id`(`stu_id` ASC) USING BTREE COMMENT '学生ID索引'
) ENGINE = InnoDB AUTO_INCREMENT = 21007 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生订单表' ROW_FORMAT = Dynamic;
...
INSERT INTO `student_order` VALUES (21005, 'ORDER_1749612554401_fd7876a9', 1002, 10, '2025-06-11 11:29:14', '2025-06-11 11:29:14', 0);
INSERT INTO `student_order` VALUES (21006, 'ORDER_1749797258561_950b3e48', 1002, 10, '2025-06-13 14:47:38', '2025-06-13 14:47:38', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 22007 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生订单明细表' ROW_FORMAT = Dynamic;
...
INSERT INTO `student_order_detail` VALUES (22005, 21005, 7005, 10, '/uploads/img/f8bab475-25d8-44f8-9905-8a49616f636d.png', '陈海涛', 'SpringBoot实战项目开发', '2025-06-11 11:29:14', '2025-06-11 11:29:14', 0);
INSERT INTO `student_order_detail` VALUES (22006, 21006, 7002, 10, '/uploads/img/c24237b3-da35-44cd-8a4c-cfa1389e5138.png', '李教授', '机器学习入门', '2025-06-13 14:47:38', '2025-06-13 14:47:38', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 25004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生实践活动关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `student_score_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '积分明细ID',
  `stu_id` bigint NOT NULL COMMENT '学生ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 23004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生积分变动明细表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '教师信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (2001, 2001, '陈海涛', 5, '2023-01-03 09:05:00', 0, '2025-06-08 19:37:06');
INSERT INTO `teacher` VALUES (2002, 2002, '李教授', 3, '2023-01-04 14:05:00', 0, '2025-06-13 10:59:10');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '教师班级关联表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 14004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '学生每日情况记录表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '话题/问题表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of topic_question
-- ----------------------------
INSERT INTO `topic_question` VALUES (1, 1001, NULL, 0, 'Python中的装饰器如何使用？', 5, '技术问题', 3, '2023-03-07 09:00:00', 0, '2025-06-15 14:46:29', 3001);
INSERT INTO `topic_question` VALUES (2, 1002, 2002, 0, '机器学习中如何选择正确的算法？', 8, '技术问题', 5, '2023-03-08 10:00:00', 0, '2025-06-15 15:35:09', 3002);
...
) ENGINE = InnoDB AUTO_INCREMENT = 32003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '问题收藏记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of topic_question_collection
-- ----------------------------
INSERT INTO `topic_question_collection` VALUES (32001, 1001, 1, 1, '2023-03-09 09:00:00', '2025-06-14 18:59:40');
INSERT INTO `topic_question_collection` VALUES (32002, 1002, 2, 1, '2023-03-10 10:00:00', '2025-06-14 18:59:41');
...
CREATE TABLE `topic_question_comment`  (
  ...
  `tea_id` bigint NULL DEFAULT NULL COMMENT '评论教师ID',
  ...
  INDEX `idx_stu_id`(`stu_id` ASC) USING BTREE COMMENT '学生ID索引',
  INDEX `idx_tea_id`(`tea_id` ASC) USING BTREE COMMENT '教师ID索引',
  INDEX `idx_at_id`(`at_id` ASC) USING BTREE COMMENT '被@用户ID索引',
  INDEX `idx_parent_comments_id`(`parent_comments_id` ASC) USING BTREE COMMENT '父评论ID索引',
  FULLTEXT INDEX `ft_content`(`content`) COMMENT '内容全文索引'
) ENGINE = InnoDB AUTO_INCREMENT = 33040 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '问题评论表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of topic_question_comment
-- ----------------------------
INSERT INTO `topic_question_comment` VALUES (33039, 2, NULL, 2002, '213213', 0, 0, 2002, 33034, '2025-06-14 15:07:03', '2025-06-14 23:22:19', 1);
INSERT INTO `topic_question_comment` VALUES (33038, 2, NULL, 2002, '你好', 0, 0, 2002, 33034, '2025-06-14 15:04:00', '2025-06-14 15:04:00', 0);
INSERT INTO `topic_question_comment` VALUES (33037, 1, NULL, 2002, '123123', 0, 0, 1002, 33002, '2025-06-14 14:54:47', '2025-06-14 14:54:47', 0);
INSERT INTO `topic_question_comment` VALUES (33036, 1, NULL, 2002, '是啊', 0, 0, 1002, 33002, '2025-06-14 14:49:42', '2025-06-14 14:49:42', 0);
INSERT INTO `topic_question_comment` VALUES (33034, 2, NULL, 2002, '213123', 0, 0, 2002, 33033, '2025-06-14 14:44:03', '2025-06-14 23:22:24', 1);
INSERT INTO `topic_question_comment` VALUES (33033, 2, NULL, 2002, '213123', 0, 0, 2002, 33032, '2025-06-14 14:27:57', '2025-06-14 23:22:26', 1);
INSERT INTO `topic_question_comment` VALUES (33032, 2, NULL, 2002, '21321', 0, 0, 2002, 33031, '2025-06-14 14:20:42', '2025-06-14 23:22:29', 1);
INSERT INTO `topic_question_comment` VALUES (33031, 2, NULL, 2002, '21312321312', 0, 0, 2002, 33030, '2025-06-14 14:17:07', '2025-06-14 14:17:07', 0);
INSERT INTO `topic_question_comment` VALUES (33030, 2, NULL, 2002, '213213', 0, 0, 2002, 33029, '2025-06-14 14:10:48', '2025-06-14 14:10:48', 0);
INSERT INTO `topic_question_comment` VALUES (33003, 2, NULL, 2002, '选择算法需要考虑数据类型、问题类型和计算资源等因素...', 1, 5, 0, 0, '2023-03-13 09:00:00', '2025-06-14 18:55:07', 0);
INSERT INTO `topic_question_comment` VALUES (33002, 1, 1002, NULL, '能举个具体的例子吗？', 0, 1, 0, 0, '2023-03-12 10:00:00', '2025-06-14 18:55:05', 0);
INSERT INTO `topic_question_comment` VALUES (33001, 1, NULL, 2001, '装饰器是Python中一个强大的功能，可以用来修改或增强函数的行为...', 0, 3, 0, 0, '2023-03-11 09:00:00', '2025-06-14 18:55:04', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 34003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '问题评论点赞表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `topic_question_img`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_q_id`(`q_id` ASC) USING BTREE COMMENT '问题ID索引'
) ENGINE = InnoDB AUTO_INCREMENT = 35003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '问题图片表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of topic_question_img
-- ----------------------------
INSERT INTO `topic_question_img` VALUES (35001, 1, 'https://example.com/questions/decorator-example.jpg', 0, '2023-03-16 09:00:00', '2025-06-14 18:59:55');
INSERT INTO `topic_question_img` VALUES (35002, 2, 'https://example.com/questions/ml-algorithm.jpg', 0, '2023-03-17 10:00:00', '2025-06-14 18:59:56');
...
CREATE TABLE `topic_question_like`  (
  ...
  INDEX `idx_q_id`(`q_id` ASC) USING BTREE COMMENT '问题ID索引'
) ENGINE = InnoDB AUTO_INCREMENT = 36003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '问题点赞记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of topic_question_like
-- ----------------------------
INSERT INTO `topic_question_like` VALUES (36001, 1001, 1, 1, '2023-03-18 09:00:00', '2025-06-14 18:59:59');
INSERT INTO `topic_question_like` VALUES (36002, 1002, 2, 1, '2023-03-19 10:00:00', '2025-06-14 19:00:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户基础信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1001, 1, 'student1', '$2a$10$wHhPVD/35z08O3Zh5IXsSu1O9cqUXpY8Ikv2Ie6bKPJYxUScKmcja', 'https://example.com/avatars/student1.jpg', '2023-01-01 10:00:00', 0, '2025-06-13 16:58:49');
INSERT INTO `user` VALUES (1002, 1, 'student2', '$2a$10$hJhlg9uddcZjVQSPMC2KMO4y1vaqQxE8W3lOv1x4mm1l0J4TdQqBK', 'https://example.com/avatars/student2.jpg', '2023-01-02 11:00:00', 0, '2025-06-16 14:05:55');
INSERT INTO `user` VALUES (2001, 0, 'teacher1', '$2a$05$DWGinMmO00tRkGb.2IVwguvI/ZIKiwfYoKp2MMNKaSx7PnSlJMI9y', '/uploads/avatar/avatar_92ff9159-1ffb-4d2e-8dc2-54db149932e3.png', '2023-01-03 09:00:00', 0, '2025-06-13 09:34:02');
INSERT INTO `user` VALUES (2002, 0, 'teacher2', '$2a$05$EDmIfTlEbJJd6YGTFGGn.eFazMB89bZJynTXTxKOiIdhg/IwBrpxa', '/uploads/avatar/avatar_7da0c8cd-a0b0-4704-911a-71b649e0da8f.png', '2023-01-04 14:00:00', 0, '2025-06-16 21:43:21');
...
) ENGINE = InnoDB AUTO_INCREMENT = 44003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户违规记录表' ROW_FORMAT = Dynamic;
